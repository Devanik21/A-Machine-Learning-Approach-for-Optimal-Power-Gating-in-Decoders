...
class EvolutionaryOptimizer:
    ...
    def run(self):
        ...
        final_netlist_path = os.path.join(self.env.working_dir, "4_16_GEOMETRIC_OPTIMIZED_FINAL.net")
...
if __name__ == "__main__":
    ...
    optimizer = EvolutionaryOptimizer(env, pop_size=10, generations=10, mutation_rate=0.25)
    optimizer.run()
